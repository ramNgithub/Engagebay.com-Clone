        ...
        <div data-aos="fade-right" className="SingleSolution_div_one">
          <div className="SingleSolution_div_one_ineer">
            <div>
              <p style={{ color: "gray" }}>
                {" "}
                <b style={{ fontSize: "20px", color: "black" }}>CRM Software</b>
                <br />
                <br />
                Store unlimited contacts and build stronger
                <br /> relationships by keeping track of all your customer{" "}
                <br /> details in one place
              </p>
            </div>
            <div>
              <img
          ...
          <div style={{ marginLeft: "40px" }}>
            <br />
            <b style={{ color: "black" }}>POPULAR FEATURES</b>
            <br />
              ...
              <div>
                ...
                >
                  <img
                    ...
                    src="https://www.catherine-capaldo.com/wp-content/uploads/2019/01/check-300x300.png' "
                    alt="Not-Found"
                  />
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "5px",
                color: "white",
                backgroundColor: " rgb(105, 43, 204)",
                border: "none",
              }}
            >
              Get Started
          ...
          <div className="SingleSolution_div_one_ineer">
            <div>
              <p style={{ color: "gray" }}>
                ...
                <br />
                <br />
                Save time by automating your marketing processes
                <br /> and sending personalized messages to target
                <br /> audiences
              </p>
            </div>
            <div>
          ...
          <div className="SingleSolution_div_one_ineer">
            <div>
              <p style={{ color: "gray" }}>
                ...
                <br />
                <br />
                Resolve queries faster and deliver exceptional <br /> support to
          ...
          <div className="SingleSolution_div_one_ineer">
            <div>
              <p style={{ color: "gray" }}>
                ...
                <br />
                <br />
                Boost customer happiness and increase conversions
                <br />
